...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Windu.Group — производство и установка окон ПВХ, алюминиевых окон, дверей, балконов и витражей в Грозном и по всей Чеченской Республике с 2018 года. Более 1200 сданных объектов, гарантия до 10 лет, рассрочка 0%." },
      ...
      { property: "og:description", content: "Производство и установка окон, дверей и балконов в Чеченской Республике с 2018 года. Более 1200 объектов, гарантия 10 лет." },
...
const values = [
  ...
  { icon: Users, title: "Штат 40+ специалистов", text: "Замерщики, инженеры, монтажники и сервисная бригада — все в штате компании." },
...
const milestones = [
  ...
  { year: "2026", text: "1200+ выполненных заказов, гарантия увеличена до 10 лет, запуск онлайн-калькулятора и премиум-линейки." },
];
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-white/85">
              ...
              За плечами команды — более 1200 сданных объектов: квартиры, частные дома, магазины, кафе, офисы и бизнес-центры.
            </p>
